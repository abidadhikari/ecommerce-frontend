  ...
  return (
    <>
      <div className=" bg-black text-white">
        <div className="container gap-10 md:gap-5 grid grid-cols-1 sm:grid-cols-2 md:flex justify-between py-20 font-sans flex-wrap">
          <div>
       ...
       <SendIcon className="ml-[-40px]"/> */}
              <div className="relative ">
                <input
                  ...
                  className="text-gray-400 font-light w-full bg-black border rounded border-gray-400 p-3"
                />
                <SendIcon className="absolute bottom-3 right-7" />
              </div>
            </form>
          </div>
          <div>
            ...
            <p className="pb-4">
              111 Koteshwor, Kathmandu,<br></br> KTM 44600, Nepal
            </p>
            ...
            <div className="flex pt-3">
              ...
              <div className="ml-4">
                <img
                  src="/google play.png"
                  alt="googleplay"
                  className="object-cover h-10 w-28 border-2 rounded border-gray-400"
                />
                <img
                  src="/app store.png"
                  alt="appstore"
                  className="object-cover h-10 w-28 border-2 rounded border-gray-400 mt-4"
                />
              </div>
            </div>
        ...
        <div className="container text-white bg-black text-gray-700 p-5 border-t border-gray-800 text-center">
